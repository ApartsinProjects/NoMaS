...
<p>SPARC builds synthetic anomalies from the normal data and grades detectors on how well they find them, and is the only method to significantly beat both survivors: regret, the gap to the best available detector, is 0.124 versus 0.176 for entropy and 0.174 for mass-volume, $p<0.001$ against each. The gain is decisive on time series (0.05 versus 0.15) and holds on tabular data. We release the benchmark, the detector scores, and the code.</p>
</div>
