...
<figure>
<img src="figures/fig_leaderboard.png" alt="Grouped bar chart of selection regret per method on the classical, deep-only, and full detector pools; on the classical pool SPARC is lowest at 0.113, Goswami 0.122, best fixed detector 0.130, entropy and mass-volume near 0.164, agreement selectors near the random reference; every method's regret rises on the full and deep-only pools.">
