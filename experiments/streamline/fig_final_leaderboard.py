...
bars = [("NoMaS combined (ours)", macro("reg_combined"), "#2a9d8f"), ("NoMaS \u03b2=1 (ours)", macro("reg_beta1"), "#40b3a2"),
        ("NoMaS corr_str (ours)", macro("reg_corr_str"), "#40b3a2"), ("NoMaS matched (ours)", macro("reg_matched"), "#7fccc0"),
